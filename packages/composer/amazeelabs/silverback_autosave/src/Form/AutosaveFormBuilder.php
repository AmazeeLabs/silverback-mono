...
use Drupal\silverback_autosave\EmptyAlter\Extension\ModuleHandlerEmptyAlter;
use Drupal\silverback_autosave\EmptyAlter\Theme\ThemeManagerEmptyAlter;
...
class AutosaveFormBuilder extends FormBuilder {
  ...
  protected function restoreAutosavedState($form_id, FormStateInterface $form_state) {
    if (!$form_state->get('silverback_autosave_restored') && ($autosaved_timestamp = $form_state->get('silverback_autosave_state_timestamp'))) {
      ...
      if ($form_object instanceof EntityFormInterface) {
        ...
        $form_state->set('silverback_autosave_restored', TRUE);
      }
