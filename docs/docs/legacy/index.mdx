...
:::danger
This documentation is not up-do-date and needs to be reworked.
:::
...
- **Automate everything:** Testing is boring, updating is boring, deploying is
  ...
  strive to free our minds from as much boring work as possible. The more that
  we can offset this repetitive or boring work onto machines, the more we can
  put our brains to work on more creative and interesting tasks.
...
- **Decoupled frontend:** Starter kits, libraries and workflows we employ to
  work with the Gatsby and the React ecosystem and connect it to our data
  backends.
...
- **Content management:** Systems to model how documents are managed. Ranging
  ...
  workspaces, Delivery).
- **Tooling & Automation:** Everything that makes developers lives easier, like
  Linting, automated testing and release management.

### Implementation

On a technical level the _Silverback_ mono-repository serves as the central
point for developing, maintaining and documenting our open source solutions. It
helps us to easily apply changes and run integration tests across the multiple
interconnected projects that we contribute to, and it automatically publishes
them to their respective ecosystems, like npmjs, drupal.org or packagist.
