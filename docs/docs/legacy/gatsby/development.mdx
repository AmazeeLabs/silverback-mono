...
- `/src/components`: Standard React components used to build your site. See [the `src/components/\_README.md](../methodology/frontend-architecture) file to understand how to keep components organized.
