---
title: Cypress Screenplay
path: /tooling/cypress/screenplay
nav: Tooling
position: 3
---
...
Every test case is a series of user interactions with the system. There are two
fundamental types of interactions: _Task_ and _Questions_. When executing a
